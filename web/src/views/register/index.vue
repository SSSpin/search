  ...
  <div class="login-container">
    <el-form class="card-box login-form" autoComplete="on" :model="loginForm" :rules="loginRules" ref="loginForm" label-position="left">
      ...
      <el-form-item prop="password">
        ...
        <el-input name="password" :type="pwdType" v-model="loginForm.password" autoComplete="on" placeholder="输入密码" />
      ...
      <el-form-item prop="confrimPassword">
        ...
        <el-input name="confrimPassword" :type="pwdType" v-model="loginForm.confrimPassword" autoComplete="on" placeholder="确认密码" />
        <span class='show-pwd' @click='showPwd'><icon-svg icon-class="eye" /></span>
      </el-form-item>
...
export default {
  ...
  data() {
    ...
    const validateConfirmPassword = (rule, value, callback) => {
      if (value !==this.$data.loginForm.password) {
